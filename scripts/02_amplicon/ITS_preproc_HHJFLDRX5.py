...
manifest_path = '/N/scratch/rebelann/MG_runs/manifests/manifest_ITS_HHJFLDRX5.tsv'
output_dir    = '/N/scratch/rebelann/MG_runs/dada2_output/ITS/HHJFLDRX5'
...
print("DADA2 preprocessing complete for ITS HHJFLDRX5.")
