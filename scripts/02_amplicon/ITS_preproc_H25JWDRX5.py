...
manifest_path = '/N/scratch/rebelann/MG_runs/manifests/manifest_ITS_H25JWDRX5.tsv'
output_dir    = '/N/scratch/rebelann/MG_runs/dada2_output/ITS/H25JWDRX5'
...
print("DADA2 preprocessing complete for ITS H25JWDRX5.")
