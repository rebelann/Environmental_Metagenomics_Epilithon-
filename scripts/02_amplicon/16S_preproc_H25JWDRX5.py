...
manifest_path = '/N/scratch/rebelann/MG_runs/manifests/manifest_16S_H25JWDRX5.tsv'
output_dir    = '/N/scratch/rebelann/MG_runs/dada2_output/H25JWDRX5'
...
print("DADA2 preprocessing complete for H25JWDRX5.")
